...
from playground.Non_DAG_with_Energy.utils.tools import multiprocessing_run, average_completion, average_slowdown,average_waiting_time
...
import playground.Non_DAG_with_Energy.algorithm.DQN_train_on_epoch.DQN_algorithm as dqn_top
algorithm = dqn_top.DQNAlgorithm(machine_configs)
...
for i in range(n_iter):
    ...
    print(episode.env.now, time.time() - tic, average_completion_res,average_waitting_time_res, average_slowdown(episode))
    algorithm.dqn.learn()
    algorithm.reset()
