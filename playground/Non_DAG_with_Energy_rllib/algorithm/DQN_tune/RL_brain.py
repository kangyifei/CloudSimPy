    ...
    def _build_net(self):
        ...
        with tf.compat.v1.variable_scope('eval_net'):
            ...
            with tf.compat.v1.variable_scope('l1'):
                w1 = tf.compat.v1.get_variable('w1', [self.n_features, self.tuneconfig.get("l1")],
                                               initializer=w_initializer,
                                               collections=c_names)
                b1 = tf.compat.v1.get_variable('b1', [1, self.tuneconfig.get("l1")], initializer=b_initializer,
                                               collections=c_names)
                l1 = tf.compat.v1.nn.relu(tf.matmul(self.s, w1) + b1)
            with tf.compat.v1.variable_scope('l2'):
                w2 = tf.compat.v1.get_variable('w2', [self.tuneconfig.get("l1"), self.tuneconfig.get("l2")],
                                               initializer=w_initializer, collections=c_names)
                b2 = tf.compat.v1.get_variable('b2', [1, self.tuneconfig.get("l2")], initializer=b_initializer,
                                               collections=c_names)
                l2 = tf.compat.v1.nn.relu(tf.matmul(l1, w2) + b2)
            with tf.compat.v1.variable_scope('l3'):
                w3 = tf.compat.v1.get_variable('w3', [self.tuneconfig.get("l2"), self.tuneconfig.get("l3")],
                                               initializer=w_initializer, collections=c_names)
                b3 = tf.compat.v1.get_variable('b3', [1, self.tuneconfig.get("l3")], initializer=b_initializer,
                                               collections=c_names)
                l3 = tf.compat.v1.nn.relu(tf.matmul(l2, w3) + b3)
            with tf.compat.v1.variable_scope('l4'):
                w4 = tf.compat.v1.get_variable('w4', [self.tuneconfig.get("l3"), self.tuneconfig.get("l4")],
                                               initializer=w_initializer, collections=c_names)
                b4 = tf.compat.v1.get_variable('b4', [1, self.tuneconfig.get("l4")], initializer=b_initializer,
                                               collections=c_names)
            ...
            with tf.compat.v1.variable_scope('l5'):
                w5 = tf.compat.v1.get_variable('w5', [self.tuneconfig.get("l4"), self.n_actions],
                                               initializer=w_initializer,
                                               collections=c_names)
