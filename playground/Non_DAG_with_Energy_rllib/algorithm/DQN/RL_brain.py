    ...
    def _build_net(self):
        ...
        with tf.compat.v1.variable_scope('eval_net'):
            ...
            with tf.compat.v1.variable_scope('l3'):
                w3 = tf.compat.v1.get_variable('w3', [20, 100], initializer=w_initializer, collections=c_names)
                b3 = tf.compat.v1.get_variable('b3', [1, 100], initializer=b_initializer, collections=c_names)
                l3 = tf.compat.v1.nn.relu(tf.matmul(l2, w3) + b3)
            with tf.compat.v1.variable_scope('l4'):
                w4 = tf.compat.v1.get_variable('w4', [100, 20], initializer=w_initializer, collections=c_names)
