...
import playground.Non_DAG_with_Energy.algorithm.DQN_adam.DQN_algorithm as dqn
algorithm = dqn.DQNAlgorithm(machine_configs)
...
plt.xlabel('l2:energy_consume/total_reward_of_ep')
plt.show()
